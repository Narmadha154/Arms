...
public class ArrayListTaskRunner{
   ...
   public static List<String> createStringArrayList(){
    ...
    if(num==0){
      System.out.println("NullPointer Exception coming");
    }
    else{
  ...
  public static List<Double> createDecimalArrayList(){
    ...
    for(int i=0;i<num;i++)
    {
      ...
      System.out.println("Invalid input! you have to enter a double");
       sc.next();
      createDecimalArrayList();
    }
}
  ...
  public static List<Student> createCustomList(){
      ...
      for(int i=0;i<size;i++){
          ...
          obj.setName(name);
          obj.setMarks(marks);
          customList.add(obj.getRollNo(),obj.getName(),obj.getMarks());
      }
      return customList;
    }
