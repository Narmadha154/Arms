 Write a Java program to find the index of an array element. (numeric array).
 Write a Java program to sum values of a numeric array. 
 Write a Java program to remove a specific element from an array.
 Write a Java program to insert an element (specific position) into an array.
 Write a Java program to test if an array contains a specific value.
 Write a Java program to find the maximum and minimum value of a numeric array. 
 i.Write a Java program to find the common elements between two arrays (string values).
 ...
 Write a Java program to print all the LEADERS in the array. Note: An element is leader if it is greater than all the elements to its right side.
